...
#define NUM_MOTORS 2  // 8 个步进电机

// 定义每个电机的控制引脚（NPN接口）
// 每个电机3个引脚：顺时针 (CW)、停止 (STOP)、逆时针 (CCW)
const int PIN_CW[NUM_MOTORS]   = {2, 3};
const int PIN_STOP[NUM_MOTORS] = {10, 11};
const int PIN_CCW[NUM_MOTORS]  = {4,5};
...
volatile unsigned long threshold[NUM_MOTORS] = {80,80};  // 比如 80 次中断 = 80*50us = 4000us = 4ms
