...
%       derivation.
    ...
    % Cable 1:
    Term1_x = x - container_size - (b*(cos(gamma)*sin(alpha) - cos(alpha)*sin(beta)*sin(gamma)))/2 ...
    ...
    Term5_x = container_size - x + (b*(cos(gamma)*sin(alpha) - cos(alpha)*sin(beta)*sin(gamma)))/2 ...
              + (c*(sin(alpha)*sin(gamma) + cos(alpha)*cos(gamma)*sin(beta)))/2 ...
              - (a*cos(alpha)*cos(beta))/2;
    Term5_y = y - container_size + (b*(cos(alpha)*cos(gamma) + sin(alpha)*sin(beta)*sin(gamma)))/2 ...
              + (c*(cos(alpha)*sin(gamma) - cos(gamma)*sin(alpha)*sin(beta)))/2 ...
              + (a*cos(beta)*sin(alpha))/2;
    ...
    Term6_x = x - container_size + (b*(cos(gamma)*sin(alpha) - cos(alpha)*sin(beta)*sin(gamma)))/2 ...
              - (c*(sin(alpha)*sin(gamma) + cos(alpha)*cos(gamma)*sin(beta)))/2 ...
              + (a*cos(alpha)*cos(beta))/2;
    Term6_y = y - (b*(cos(alpha)*cos(gamma) + sin(alpha)*sin(beta)*sin(gamma)))/2 ...
              + (c*(cos(alpha)*sin(gamma) - cos(gamma)*sin(alpha)*sin(beta)))/2 ...
              + (a*cos(beta)*sin(alpha))/2;
    ...
    Term7_x = x + (b*(cos(gamma)*sin(alpha) - cos(alpha)*sin(beta)*sin(gamma)))/2 ...
              - (c*(sin(alpha)*sin(gamma) + cos(alpha)*cos(gamma)*sin(beta)))/2 ...
              - (a*cos(alpha)*cos(beta))/2;
    Term7_y = y - (b*(cos(alpha)*cos(gamma) + sin(alpha)*sin(beta)*sin(gamma)))/2 ...
              + (c*(cos(alpha)*sin(gamma) - cos(gamma)*sin(alpha)*sin(beta)))/2 ...
              - (a*cos(beta)*sin(alpha))/2;
